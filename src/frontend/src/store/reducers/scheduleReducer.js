const initState = {
     ...
     * descriptors
     * 
     * @description List of column descriptors for a schedule
     */
    descriptors:[
     ...
     * schedules
     * 
     * @description Contains all the possible schedules
    ...
    /* // contains a list of saved schedules */
    savedSchedules:[],
     ...
     * viewing
     * 
     * @description Reflects the state of the viewing button
     ...
     * sorters
     * 
     * @description Contains the different sorters
     ...
     * filters
     * 
     * @description Contains the different filters
 ...
 * cloneSchedules 
 * 
 * @description Clones a given schedule to prevent state destruction
 * @param {*} schedules 
 */
/*
 ...
 * filterSchedules
 * 
 * @description Filters a given schedule, prevents state destruction 
 * @param {*} schedules 
 * @param {*} selected 
 */
 ...
 * cloneViewing 
 * 
 * @description Clones the viewing list ot prevent state destruction
 * @param {*} viewing 
 */
 ...
 * studentReducer 
 * 
 * @description Modifies the state according to dispatched action 
 * @param {*} state 
 * @param {*} action 
 */
